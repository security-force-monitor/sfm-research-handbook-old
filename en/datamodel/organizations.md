...
| [Parent relationship: start date?](#organization_parent_date_first_cited_is_start) | Is the value in `Parent relationship: Date first cited` the actual date on which an organization became the parent of another, or the earliest date a source has referred to the relationship? | `Y`, `N` |
...
| [Site: Top Administrative Area \(OSM Name\)](#organization_site_top_admin_name) | The OSM name of the largest, generally used administrative area of a country | Borno , Rivers , Baja California |
