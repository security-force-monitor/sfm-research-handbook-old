...
Please use this field to put your name/initials and date on rows you enter data on \(This will be auto-filled by the Content Management System \(CMS\) being built right now.\)
...
The division\_id enables the system to identify which country this organization belongs to, thus all entries in this field would be “ocd-division/country:” followed by the two letter country code.
...
## Area of Operations division\_id
